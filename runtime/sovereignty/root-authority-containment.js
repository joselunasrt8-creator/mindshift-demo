...
export const ROOT_AUTHORITY_BASELINE_SURFACES = Object.freeze([
  { surface_id: 'cloudflare_account_authority', authority_origin: 'cloudflare_account', declared_boundary: 'external-root-cloudflare-account-containment-required', classifications: ['ROOT_DEPLOY_AUTHORITY', 'ROOT_RUNTIME_CONFIGURATION_AUTHORITY', 'ROOT_INFRASTRUCTURE_MUTATION_AUTHORITY', 'ROOT_AUTHORITY_CONTAINMENT_REQUIRED'] },
  ...
  { surface_id: 'github_admin_authority', authority_origin: 'github_repository_admin', declared_boundary: 'external-root-github-admin-and-branch-policy-containment-required', classifications: ['ROOT_REPOSITORY_AUTHORITY', 'ROOT_BRANCH_POLICY_AUTHORITY', 'ROOT_WORKFLOW_AUTHORITY', 'ROOT_AUTHORITY_CONTAINMENT_REQUIRED'] },
