...
export const ECONOMIC_DRIFT_CLASS = 'economic_drift'

export function validateExecutionQuota(quota) {
...
export function consumeQuotaOnce(quota) {
...
export function economicRejectionPayload(reason, quota = null) {
  return {
    status: 'NULL',
    result: 'INVALID',
    reason,
